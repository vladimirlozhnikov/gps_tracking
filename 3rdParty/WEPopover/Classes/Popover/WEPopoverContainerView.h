...
@property(nonatomic, weak) NSString *bgImageName;
@property(nonatomic, weak) NSString *upArrowImageName;
@property(nonatomic, weak) NSString *downArrowImageName;
@property(nonatomic, weak) NSString *leftArrowImageName;
@property(nonatomic, weak) NSString *rightArrowImageName;
